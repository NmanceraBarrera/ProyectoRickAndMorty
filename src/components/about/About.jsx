      ...
      <footer className={style.footer}>
        <div className={style.footerContainer}>
          ...
          <div className={style.redes}>
            ...
            <a href="https://www.linkedin.com/in/nicolas-mancera-barrera-706764295/"><BsLinkedin className={style.icon} /></a>
            <a href="https://github.com/NmanceraBarrera"><BsGithub className={style.icon} /></a>
